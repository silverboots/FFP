...
st.dataframe(
    ...
    column_config={
        ...
        "Form": st.column_config.NumberColumn("Form", format="%.2f"),
        ...
        "ICT": st.column_config.NumberColumn("ICT", format="%.2f"),
        "Infl": st.column_config.NumberColumn("Infl", format="%.2f"),
        "Creat": st.column_config.NumberColumn("Creat", format="%.2f"),
        "Threat": st.column_config.NumberColumn("Threat", format="%.2f"),
        "Rating": st.column_config.NumberColumn("Rating", format="%.2f"),
        "Min/90": st.column_config.NumberColumn("Min/90", format="%.2f"),
        "Diff3": st.column_config.NumberColumn("Diff3", format="%.2f"),
        "Atk1": st.column_config.NumberColumn("Atk1", format="%.2f"),
        "Def1": st.column_config.NumberColumn("Def1", format="%.2f"),
        "Atk2": st.column_config.NumberColumn("Atk2", format="%.2f"),
        "Def2": st.column_config.NumberColumn("Def2", format="%.2f"),
        "Atk3": st.column_config.NumberColumn("Atk3", format="%.2f"),
        "Def3": st.column_config.NumberColumn("Def3", format="%.2f"),
        "Atk4": st.column_config.NumberColumn("Atk4", format="%.2f"),
        "Def4": st.column_config.NumberColumn("Def4", format="%.2f"),
        "Atk5": st.column_config.NumberColumn("Atk5", format="%.2f"),
        "Def5": st.column_config.NumberColumn("Def5", format="%.2f"),
        "Atk6": st.column_config.NumberColumn("Atk6", format="%.2f"),
        "Def6": st.column_config.NumberColumn("Def6", format="%.2f"),
    }
)
